        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                if(empty($title) or empty($post_data) or empty($tags)){
                    ...
                    $insert_query = "INSERT INTO posts (date,title,author,image,categories,tags,post_data,views,status) VALUES ('$date','$title','$session_username','$image','$categories','$tags','$post_data','0','$status')";
